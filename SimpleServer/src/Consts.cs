...
namespace SimpleServer.src
{
    public class Consts
    {
        ...
        public const string PasswordValidationError = "Password must have more than 6 characters, min. 1 uppercase, min. 1 lowercase, min. 1 special characters,min. 1 number,min.";
